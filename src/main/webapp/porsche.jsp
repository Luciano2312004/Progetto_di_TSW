  ...
  <main class="main">
         ...
         <section class="home grid section" id="home">
				...
				<h1 class="home__title">PORSCHE</h1>
				  ...
				  <h3>POTENZA (KW)</h3>
				  <p><span class="info__num" data-target="620">0</span>CV (652KW) <br>8.250 giri/min </p>
				   ...
				   <div class="info__group">
				  <h3>MAX. VELOCITÀ</h3>
				  <p><span class="info__num" data-target="345">0</span> km/h</p>
				   ...
				   <div class="info__group">
				  <h3>0-100 KM/H</h3>
				  <p><span class="info__num" data-target="2.6">0</span> - 2.7s</p>
